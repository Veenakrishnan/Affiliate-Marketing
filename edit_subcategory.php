...
$temp=$_SESSION["email"];
$id=$_GET["id"];
$sql=mysqli_query($conn,"select * from subcategory where subcategory_id=$id");
...
if(isset($_POST["submit"])){
    ...
    if(isset($_POST["active_status"]))
        ...
        $active_status=0;
    $result=mysqli_query($conn,"UPDATE  subcategory SET subcategory_name='$subcategory_name',active_status='$active_status' WHERE subcategory_id=$id");	 
...
<div class="wrapper">
        ...
        <section class="col-lg-7 connectedSortable">        
            <form action="" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="subcategory_name" name="subcategory_name" value="<?php echo $row["subcategory_name"]; ?>">
                </div>
                ...
                <div class="form-group form-check">
                    ...
                    <?php  
                         if($row["active_status"]==1){
                             ?>
                         <input type="checkbox"  name="active_status" checked="checked">
                      <?php
                         }
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy;  <a href="dashboard.php">Affiliated Management</a>.</strong> All rights
    reserved.
  </footer>
