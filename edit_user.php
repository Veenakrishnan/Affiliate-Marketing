...
if(isset($_POST["submit"])){
    ...
    if(isset($_POST["active_status"]))
        ...
        $active_status=0;
    $result=mysqli_query($conn,"UPDATE  user SET username='$username',email='$email',mobile='$mobile',active_status='$active_status' WHERE user_id=$id");	 
...
<div class="wrapper">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy;  <a href="dashboard.php">Affiliated Maketing</a>.</strong> All rights
    reserved.
  </footer>
