      ...
      <div class="row">
        ...
        <section class="col-lg-7 connectedSortable">        
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <tr><th colspan="3">Category Name</th>
                    <th colspan="3">Sub Category Name</th>
                    ...
                    <tr>
                        <?php
                            ...
                            { 
                                $id=$row["category_id"];
                                $query=mysqli_query($conn,"select category_name from category where category_id=$id");
                                 $result = mysqli_fetch_assoc($query);
                                ?>
                        <td colspan="3"><?php echo $result["category_name"] ?></td>
                        <td colspan="3"><?php echo $row["subcategory_name"]; ?></td>
                        <td colspan="3"><?php  
                      ...
                      <?php
                       ...
                       <input type="checkbox" disabled name="active_status">
                        <?php
                                ...
                                ?></td>
                    <td colspan="3">
                        <a href="edit_subcategory.php?id=<?php echo $row['subcategory_id']?>">Edit</a> | <a href="delete_subcategory.php?id=<?php echo $row['subcategory_id']?>">Delete</a></td>
                    </tr>
                        <?php
                            }
                        ?>
