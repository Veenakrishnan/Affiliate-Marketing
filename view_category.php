                ...
                <tr><th colspan="3">Category Name</th>
                    ...
                    <tr>
                        <?php
                            ...
                            { 
                                ?>
                        <td colspan="3"><?php echo $row["category_name"]; ?></td>
                        <td colspan="3"><?php  
                      ...
                      <?php
                       ...
                       <input type="checkbox" disabled name="active_status">
                        <?php
                                ...
                                ?></td>
                    <td colspan="3">
                        <a href="edit_category.php?id=<?php echo $row['category_id']?>">Edit</a> | <a href="delete_category.php?id=<?php echo $row['category_id']?>">Delete</a></td>
                    </tr>
                        <?php
                            }
                        ?>
