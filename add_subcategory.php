...
if(isset($_POST["submit"])){   
        ...
        $active_status=0;
        $query="select * from subcategory where subcategory_name='$subcategory_name'";
        ...
        if($row>0){
            echo "<script>
				    alert('Subcategory name must be unique...');
	                   ...
	                   echo $sql1="insert into subcategory(subcategory_name,category_id,active_status)  values('".$subcategory_name."','".$category_id."','".$active_status."')";
...
<head>
  ...
  <![endif]-->
	...
	{	
	var j = document.forms["form1"]["category_id"].value;
	if (j==null || j=="") 
	{
        ...
        <section class="col-lg-7 connectedSortable">        
            <form action="" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return validateForm()">
                <div class="form-group">
                    ...
                    <select name="category_id" class="form-control" onChange="this.value" required>
                ...
                <div class="form-group form-check">
                    ...
                    <input class="form-check-input" type="checkbox" checked="checked" name="active_status"> ACTIVE STATUS
                    </label>
                </div>
