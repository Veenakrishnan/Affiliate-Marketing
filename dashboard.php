...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="dashboard.php" class="logo">
      ...
      <span class="logo-lg"><b>Affiliated</b>Management</span>
    </a>
      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3><?php 
                  $s=mysqli_query($conn,"select * from category");
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <h3><?php 
                  $s=mysqli_query($conn,"select * from subcategory");
                 echo $count=mysqli_num_rows($s);
                  ?></h3>
            ...
            <a href="view_subcategory.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
